    ...
    <ScrollView>
      ...
      <View style={[styles.first, {height: 125}]}>
        ...
        <Icon
          ...
          size={20}
          color="#544c4c"
          style={[styles.privacy, {bottom: 53}]}
        />
        ...
        <Icon
          ...
          size={20}
          color="#544c4c"
          style={[styles.notification, , {bottom: 11}]}
        />
      </View>
      ...
      <View style={[styles.first, {height: 95}]}>
        ...
        <Icon
          ...
          size={20}
          color="#544c4c"
          style={[styles.privacy, {bottom: 23}]}
        />
      </View>
      <Text style={styles.subhead}>Records</Text>
      <View style={[styles.first, {height: 50}]}>
        <Text style={styles.text} onPress={()=> navigation.navigate('test')} >My Records</Text>
        <Icon
          name="file"
          size={20}
          color="#544c4c"
          style={[styles.email, {bottom: 18}]}
        />
